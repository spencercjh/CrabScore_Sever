...
/**
 * Servlet implementation class GenerateCrabTasteScore
 */
@WebServlet("/GenerateCrabTasteScore")
public class GenerateCrabTasteScore extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GenerateCrabTasteScore() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String query_sql = "select score_fin from rxpb_score_taste where competition_id=" + competition_id
