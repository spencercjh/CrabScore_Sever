...
/**
 * Servlet implementation class QueryGroupID
 */
@WebServlet("/QueryGroupID")
public class QueryGroupID extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String query_sql = "select group_id from rxpb_crab_info where crab_label='" + crab_label + "'";
		try {
			// 连接数据库
			...
			// 输出结果
			System.out.println("group :" + jsonarray);
