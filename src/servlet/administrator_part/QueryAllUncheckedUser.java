...
/**
 * Servlet implementation class QueryAllUncheckedUser
 */
@WebServlet("/QueryAllUncheckedUser")
public class QueryAllUncheckedUser extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public QueryAllUncheckedUser() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String query_sql = "select * from rxpb_user_info where status = 0";
		try {
			// 连接数据库
			...
			System.out.println("query unchecked user failed");
			out.println("query unchecked user failed");
