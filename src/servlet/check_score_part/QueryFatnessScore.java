...
/**
 * Servlet implementation class QueryFatnessScore
 */
@WebServlet("/QueryFatnessScore")
public class QueryFatnessScore extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public QueryFatnessScore() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (resultset.next()) {
				...
				jsonobj.put("fatness_score_m", resultset.getFloat("fatness_score_m"));
				jsonobj.put("fatness_score_f", resultset.getFloat("fatness_score_f"));
				jsonarray.add(jsonobj);
			}
			// 输出结果
			System.out.println("fatness score list:" + jsonarray);
			...
			System.out.println("query fatness score list failed");
			out.println("query fatness score list failed");
