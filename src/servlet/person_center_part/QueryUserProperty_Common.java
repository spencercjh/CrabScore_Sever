...
/**
 * Servlet implementation class QueryUserProperty_Common
 */
@WebServlet("/QueryUserProperty_Common")
public class QueryUserProperty_Common extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public QueryUserProperty_Common() {
		super();
