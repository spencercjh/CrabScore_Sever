...
/**
 * Servlet implementation class UpdateUserDisplayName
 */
@WebServlet("/UpdateUserDisplayName")
public class UpdateUserDisplayName extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String update_sql = "UPDATE rxpb_user_info SET display_name='" + display_name + "',update_user='" + update_user
		...
		try {
			...
			System.out.println("update user display name success");
			out.println("update user display name success");
			// 关闭连接
			conn.close();
			statement.close();
		} catch (SQLException se) {
			System.out.println("update user display name failed");
			out.println("update user display name failed");
